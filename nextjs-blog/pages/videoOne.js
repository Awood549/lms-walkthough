...
class VidOne extends React.Component{
      ...
      return (
        <>
          ...
          <ReactPlayer
            ...
            <If condition = {this.context.currentUser === 'student' && this.context.videos[0].desc} >
            ...
            <If condition = {(this.context.currentUser === 'student' && this.context.videos[0].question) || this.context.currentUser === 'teacher'} >
            <form>
