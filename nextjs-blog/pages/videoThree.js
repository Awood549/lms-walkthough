...
class VidThree extends React.Component{
      ...
      return (
        <>
          ...
          <ReactPlayer
            ...
            <If condition = {this.context.currentUser === 'student' && this.context.videos[2].desc} >
            ...
            <If condition = {(this.context.currentUser === 'student' && this.context.videos[2].question) || this.context.currentUser === 'teacher'} >
            <form>
